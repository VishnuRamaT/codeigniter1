...
position: -webkit-sticky;
  position: sticky;
border-bottom: 10px solid #CF3F3F  ;
...
body{
    background-image: url("<?php echo base_url('images/im4.jpg'); ?>");
background-size: cover; 
...
<form method="post">
   ...
   <input type="text" required class ="input1"name="col1" placeholder="UserName"  ><br>
   <input type="password" required class ="input1 "name="col2" placeholder="Password" ><br>
   <input type="password" required class ="input1 "name="col3" placeholder="Confirm-Password" ><br>
   <input type="submit" class ="input2"value="Submit">
  <div id="msgg"><font color='red'> <?php echo "<br>".$msg;?></font></div>
